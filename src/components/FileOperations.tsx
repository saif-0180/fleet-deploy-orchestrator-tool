        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="bg-[#1a2b42] text-[#EEEEEE] border-2 border-[#EEEEEE]/30">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                <Label htmlFor="file-select" className="text-[#EEEEEE]">Select File</Label>
                <Select 
                  value={selectedFile} 
...
//             <h3 className="text-lg font-medium text-[#EEEEEE]">File Deployment</h3>
...
//                     <SelectTrigger 
//                       id="rollback-select" 
//                       className="bg-[#1a2b42] border-[#EEEEEE] text-[#EEEEEE] pr-8"
//                     >
//                       <SelectValue 
//                         placeholder={
//                           isLoadingDeployments 
...
//                       />
//                     </SelectTrigger>
//                     <SelectContent className="max-h-40 bg-[#1a2b42] border-[#EEEEEE]">
//                       {recentFileDeployments.map((deployment) => (
//                         <SelectItem key={deployment.id} value={deployment.id} className="text-sm text-[#EEEEEE] hover:bg-[#EEEEEE] hover:text-[#2A4759]">
//                           {formatDeploymentSummary(deployment)}
//                         </SelectItem>
//                       ))}
//                     </SelectContent>
...
//             <h3 className="text-lg font-medium text-[#EEEEEE]">Shell Command</h3>
