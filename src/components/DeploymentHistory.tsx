    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <Card className="bg-[#003459]">
            <CardHeader className="pb-2">
              <div className="flex justify-between items-center">
                <div>
                  <CardTitle className="text-[#EEEEEE] text-lg">Recent Deployments</CardTitle>
                  <p className="text-xs text-[#BBBDBC] mt-1">Last refreshed: {lastRefreshedTime}</p>
                </div>
                <Button
                  type="button"
                  onClick={handleRefresh}
                  className="bg-[#00a7e1] text-[#EEEEEE] hover:bg-[#00a7e1]/80 h-8 w-8 p-0"
                  title="Refresh"
            ...
            <CardContent>
              <div className="h-[400px] overflow-y-auto">
                {isLoadingDeployments ? (
                  ...
                  <div className="space-y-2">
                    {apiErrorMessage && (
                      <div className="p-4 bg-red-500/10 text-red-400 rounded-md mb-4 border border-red-500/20">
                    ...
                    {displayDeployments.length === 0 ? (
                      <p className="text-[#BBBDBC] italic">
                        ...
                        <div 
                          ...
                          className={`p-3 rounded-md cursor-pointer transition-colors ${
                            selectedDeploymentId === deployment.id 
                              ? 'bg-[#00a7e1] text-[#00171f]' 
                              : 'bg-[#00171f] text-[#EEEEEE] hover:bg-[#00171f]/80'
                          }`}
              ...
              <form onSubmit={handleClearLogs} className="mt-4 flex items-center space-x-2">
                ...
                <Input 
                  ...
                  className="w-20 bg-[#00171f] border-[#00a7e1] text-[#EEEEEE]"
                />
                <Button 
                  type="submit"
                  disabled={clearLogsMutation.isPending}
                  className="bg-[#00171f] text-[#EEEEEE] hover:bg-[#00a7e1]/80 border border-[#00a7e1]"
                >
          ...
          <div className="flex justify-between items-center">
            ...
            {deploymentLogs.length > 0 && (
              <Button
                ...
                className="bg-[#00a7e1] text-[#EEEEEE] hover:bg-[#00a7e1]/80 flex items-center gap-2"
                size="sm"
              >
